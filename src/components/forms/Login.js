...
function Login() {
  ...
  return (
    <>
      <button
        className="flex w-[104px] h-[54px] items-center justify-center flex-shrink-0 rounded-[5.173px] border-[2px] border-solid border-[#4B1790] "
        onClick={handleFormToggle}
      >
        <p className="flex text-[24.831px] text-[#4B1790] font-medium leading-normal">
          Log In
        </p>
      </button>
      {showForm && (
