...
function TalktoSale() {
  ...
  return (
    <>
      <div className=''>
        <button className='lg:flex items-center text-purple-600 hover:text-purple-700 transition-all duration-300 rounded py-2 px-4 bg-white ' onClick={toggleForm}><span>Talk to Sale</span></button>
      </div>

      {showForm && (
        <div className="fixed top-0 left-0  flex items-center justify-center mt-3 ">
          <div className=" bg-white p-8 rounded shadow-lg w-[600px] ">
            <h2 className="text-2xl font-bold mb-4">Talk to Sale</h2>
            <form onSubmit={handleSubmit} ref={formRef} className=''>
              <div className="">
                <label htmlFor="name" className="block text-gray-700 text-sm font-bold">First Name:</label>
              ...
              <div className="">
                <label htmlFor="name" className="block text-gray-700 text-sm font-bold">Last Name:</label>
                <input type="text" id="name" name="name" className="w-[300px] shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
              </div>
              <div className="">
